...
def save_mobile_number(workers_name):
...
def get_telephone():
    areaCode = ['0516', '0517', '0518', '0519', '010', '0570', '0571', '0572']
    first = random.choice(areaCode)
    telephone = first + '-' + str(random.randint(11111111, 99999999))
    return telephone
