...
from Page.random_data import setting_input_time, get_company_name
...
def general_contract(driver, contract_name, contract_awarding, contracting, project_name):
    ...
    try:
        ...
        # 工程属性
        get_elements(driver, ('xpath', "//input[@type='checkbox']"))[random.randint(0, 3)].click()
        driver.find_element_by_xpath("//input[@placeholder='类目']").send_keys('建筑')
        driver.find_element_by_xpath("//input[@placeholder='年份']").click()
        driver.find_element_by_xpath("//span[@class='year active']").click()
        driver.find_element_by_xpath("//input[@placeholder='编号']").send_keys(random.randint(10000, 99999))
        ...
        driver.find_elements_by_xpath("//textarea[@placeholder='选填']")[0].send_keys(project_information)
        driver.find_elements_by_xpath("//textarea[@placeholder='选填']")[1].send_keys(contract_scope)
        ...
        driver.find_elements_by_xpath("//input[@placeholder='选填']")[0].send_keys(random.randint(100, 200))
        driver.find_elements_by_xpath("//input[@placeholder='必填']")[0].send_keys(random.randint(100000, 999999))
        ...
        driver.find_elements_by_xpath("//input[@placeholder='选填']")[1].send_keys("南京路256号")
...
def subcontract(driver, project_name, labor_company, sub_contract, labor_people):
    ...
    try:
        ...
        get_element(driver, ('xpath', "//input[@placeholder='请输入劳务经理姓名']")).send_keys('咋努瓦')
