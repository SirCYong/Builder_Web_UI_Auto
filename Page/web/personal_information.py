...
from Page.random_data import get_company_name, random_str, get_org_no, get_people_name, get_mobile, setting_input_time
...
def personal_certificate(driver, file_path):
    ...
    try:
        ...
        get_element(driver, ('xpath', "//input[@placeholder='选择日期大于今天']")).send_keys(get_tomorrow_dates())
...
def add_education_experience(driver):
    ...
    try:
        ...
        school_name = get_company_name()[2:-4] + '学校'
...
def family_information(driver):
    ...
    try:
        ...
        get_elements(driver, ('xpath', "//div[@id='marry']/input"))[0].send_keys(
            get_pass_dates(100))
        get_elements(driver, ('xpath', "//div[@class='pi-plane-con-text']/input"))[1].send_keys(get_people_name())
